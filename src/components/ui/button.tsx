  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ink: "bg-perestroika-preto text-perestroika-bege hover:bg-perestroika-preto/90",
        outlineInk:
          "border-2 border-perestroika-preto/15 text-perestroika-preto hover:border-perestroika-preto/30",
        chip: "rounded-full border border-perestroika-preto/15 text-[11px] uppercase tracking-[0.2em] font-semibold hover:border-perestroika-preto/30",
      },
      size: {
        default: "min-h-11 px-5 py-2.5",
        sm: "min-h-11 rounded-xl px-4 py-2",
