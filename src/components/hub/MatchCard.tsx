...
export const MatchCard = ({ builder, reason, onOpen }: Props) => {
  ...
  return (
    <button
      ...
      className="group flex w-full gap-4 rounded-2xl border-2 border-perestroika-preto/15 bg-perestroika-bege/50 p-4 text-left transition-all hover:-translate-y-0.5 hover:border-perestroika-preto/30 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-perestroika-preto"
    >
