    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        <SectionHeader
          ...
          hint="escolha uma das 3 que você mapeou na módulo 15. só uma."
        />
        {supQ.isLoading ? (
          <p className="font-body text-xs text-perestroika-preto/60">carregando suas suposições da módulo 15…</p>
        ) : suposicoes.length === 0 ? (
          <div
          ...
          >
            ...
            <p className="font-body text-sm text-perestroika-preto/80 leading-snug">
              você ainda não fechou o mapa da módulo 15. volta lá antes de planejar o experimento.
            </p>
          </div>
        ) : (
