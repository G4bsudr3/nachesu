  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        <SectionHeader n={1} title="DIAGNÓSTICO" hint="olhando os resultados da aula 17, o que aconteceu?" />
        ...
        {resultado.value?.criterio_resultado && (
          ...
          >
            <p className="font-body text-[11px] uppercase tracking-wider text-perestroika-preto/55 mb-1">
              resultado registrado na aula 17
            </p>
      ...
      <section className="space-y-3">
        ...
        {proposta.value ? (
          ...
          <p className="font-body text-xs text-perestroika-preto/60">
            você ainda não fechou a proposta de valor da aula 13. volta lá se quiser puxar a v1.
          </p>
        )}
      </section>
      ...
      <section className="space-y-3">
        ...
        {bmc.value ? (
          ...
          <p className="font-body text-xs text-perestroika-preto/60">
            você ainda não fechou o BMC da aula 14. volta lá se quiser puxar a v1.
          </p>
        )}
      </section>
