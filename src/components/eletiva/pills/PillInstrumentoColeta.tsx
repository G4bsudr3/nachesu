...
const CAMPOS_POR_METODO: Record<Metodo, { titulo: string; campos: CampoDef[] }> = {
  ...
  concierge: {
    ...
    campos: [
      ...
      { id: "o_que_medir_extra", label: "o que vai medir de perto", hint: "além do critério da módulo 16, o que observa em cada atendimento.", min: 30, multiline: true },
    ],
  },
  fakedoor: {
...
export function PillInstrumentoColeta({
  ...
  if (planoQ.isLoading) {
    return <p className="font-body text-xs text-perestroika-preto/60">carregando seu plano da módulo 16…</p>;
  }
    ...
    return (
      ...
      >
        ...
        <p className="font-body text-sm text-perestroika-preto/80 leading-snug">
          você ainda não escolheu método na módulo 16. volta lá antes de montar o instrumento.
        </p>
      </div>
    );
  }
