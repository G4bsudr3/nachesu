 ...
 * puxa o problema escolhido (radar da módulo 1) pra ancorar o foco no topo.
 */
      ...
      >
        ...
        {problemaQuery.isLoading ? (
          ...
          <p className="font-body text-sm text-perestroika-preto/70">
            você ainda não preencheu o radar da módulo 1. volta lá primeiro pra ancorar seu mapa.
          </p>
        ) : (
