...
export const TutorContextChip = ({ moduleLabel, pillTitle }: TutorContextChipProps) => {
  ...
  return (
    <div className="px-3 py-1.5 rounded-full bg-perestroika-bege/70 border border-perestroika-preto/15 text-[11px] font-body text-perestroika-preto/70 inline-flex items-center gap-1.5">
