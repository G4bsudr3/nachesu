...
export default function AdminEletivaModulo13() {
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-8">
        <PanelHeader title={"propostas de valor da turma"} description={"quem já entregou o canvas, quantas frases-âncora estão dentro do limite de 30 palavras e o que cada estudante escreveu."} />
