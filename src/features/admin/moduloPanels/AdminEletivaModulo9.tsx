...
export default function AdminEletivaModulo9() {
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-8">
        <PanelHeader title={"matriz antes vs. depois da turma"} description={"quantos estudantes escreveram uma métrica de verdade (com número) nas 3 dimensões do triple bottom line."} />
