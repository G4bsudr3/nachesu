...
const Stat = ({ label, value }: { label: string; value: string }) => (
  <div className="rounded-xl border border-perestroika-preto/15 bg-perestroika-bege/60 px-3 py-2">
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex items-end gap-2 h-20 rounded-xl border border-perestroika-preto/15 bg-perestroika-bege/60 px-3 py-2">
          {weeks.map((w) => (
          ...
          {days.length === 0 ? (
            ...
            <ul className="space-y-1.5 max-h-72 overflow-y-auto pr-1">
              {days.map((d) => (
                <li
                  key={d.access_date}
                  className="rounded-xl border border-perestroika-preto/15 bg-perestroika-bege/60 px-3 py-2 text-xs flex items-center justify-between gap-2"
                >
