...
export const StudentInternalNotes = ({ userId }: Props) => {
  ...
  return (
    <div>
      <div className="rounded-xl border border-perestroika-preto/15 bg-white/60 p-3 mb-4">
        <Textarea
          value={draft}
      ...
      {isLoading ? (
        ...
        <ul className="space-y-2">
          {notes.map((n) => (
            <li key={n.id} className="rounded-xl border border-perestroika-preto/10 bg-white/60 p-3">
