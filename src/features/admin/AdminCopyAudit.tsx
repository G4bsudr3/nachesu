  ...
  return (
    <div>
      ...
      {pillsLoading ? (
        ...
        <div className="rounded-xl border border-perestroika-preto/15 bg-perestroika-bege/50 p-8 text-center">
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
            <div className="rounded-xl border border-perestroika-preto/15 bg-perestroika-bege/50 p-4">
            ...
            <div className="rounded-xl border border-perestroika-vermelho/30 bg-perestroika-vermelho/5 p-4">
            ...
            <div className="rounded-xl border border-perestroika-laranja/30 bg-perestroika-laranja/5 p-4">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <Select value={courseFilter} onValueChange={setCourseFilter}>
              <SelectTrigger className="bg-perestroika-bege/60 border-perestroika-preto/15 w-56">
            ...
            >
              <SelectTrigger className="bg-perestroika-bege/60 border-perestroika-preto/15 w-44">
                  ...
                  <div className="mt-3 space-y-2">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-perestroika-bege/80 border-perestroika-preto/15 mt-1"
                      />
                    </div>
                    <div>
                      <label className="text-[10px] uppercase tracking-wide text-perestroika-preto/50">
                      ...
                      <Textarea
                        ...
                        rows={6}
                        className="bg-perestroika-bege/80 border-perestroika-preto/15 mt-1 font-mono text-xs"
                      />
                    </div>
